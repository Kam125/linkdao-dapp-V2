...
import noItem from "../../images/no_item.svg";
      ...
      <div className="el-main">
        <div className="ido">
          <div className="tabs-container">
            <div className="tabs">
              <div
                className={toggleState === 1 ? "tab-pan is-active" : "tab-pan"}
                onClick={() => toggleTab(1)}
              >
                Live [0]
              </div>
              ...
              <div
                className={toggleState === 2 ? "tab-pan is-active" : "tab-pan"}
                onClick={() => toggleTab(2)}
              >
                Upcoming [0]
              </div>
              <div className="line-perch"></div>
              <div
                className={toggleState === 3 ? "tab-pan is-active" : "tab-pan"}
                onClick={() => toggleTab(3)}
              >
                Ended [3]
              </div>
              ...
              <div className="item-container">
                <div className="left" style={{ flexDirection: "row" }}>
                  ...
                  <div className="chain-info">
                    <img src={BSC} alt="" className="chain-logo" />
