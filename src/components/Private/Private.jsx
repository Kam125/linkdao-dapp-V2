          ...
          <div className="ido-detail">
            <div className="back">
              <div className="back-container">
                <Link
                  to="/Launchpad"
                  style={{ textDecoration: "none", color: "#1e1c40" }}
                >
                  <span>&#32;&#60;&#32;Back</span>
                </Link>
              </div>
              ...
              <div className="ido-container-left">
                ...
                <div className="item-column">
                  ...
                  >
                    {" "}
                    Allocation:{" "}
                    <span className="amount_color">10-25,000 BUSD</span>
                    <br />{" "}
                  </div>
                  ...
                  <div className="column-value">
                    <span style={{ lineHeight: "1.5px" }}>
                      ...
                      Private Round - 10% unlocked at TGE. The rest 90% will be
                      unlocked monthly in the next 6 months.
                    </span>
                  </div>
                </div>
                    ...
                    <div className="amount-container">
                      ...
                      {status ? (
                        <>
                          ...
                          {/* <div className="claim" onClick={handleClaim} style={{background:"rgb(255, 255, 255, 0.1)"}}> */}
                          <div
                            className="approve"
                            style={{ background: "rgb(255, 255, 255, 0.1)" }}
                          >
                        ...
                        <div className="approve disabled">Approve</div>
                      )}
                    </div>
                  </div>
                </div>
