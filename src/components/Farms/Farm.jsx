              ...
              <div className="accordion-item">
                ...
                {isActive && (
                  <div className="accordion-content">
                    ...
                    <div className="row height_295">
                      <div className="jss205 col-3">
                        ...
                        <div className="claim_box">
                          {status ? (
                            ...
                            <>
                              ...
                              <div
                                className="farm-claim"
                                onClick={() => handleApprove(address, abi)}
                              >
                                Approve
                              </div>
                            </>
                        ...
                        <p className="text_grey fsmall margin25 text_center">
                          Approve one time to enable deposit button.
                        </p>
                      ...
                      <div className="jss205 col-3 margintop25">
                        <div className="ct1-inputfarm">
                          <p>Reward Earned</p>
                      ...
                      <div className="jss205 col-3 margintop25">
                        ...
                        <p className="text_grey fsmall margin25 text_center">
                          Withdraw LP tokens + Pending {token}reward
                        </p>
                      ...
                      <div className="jss2052 col-2 margintop25">
                        <div className="ct1-input">
                          <p className="text_grey fs1vw">
                            Buy token{" "}
                            <FiExternalLink
                              style={{ color: "#52e1de" }}
                              className="v_align1"
