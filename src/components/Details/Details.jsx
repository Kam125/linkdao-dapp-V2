...
const Details = () => {
  ...
  //     if (account) {
  //       let value = await checkApprove(account,address);
              ...
              <div className="ido-container-left">
                <div className="item1">
                  ...
                  <div className="ido-desc line4hidden">
                    linkdao.network is a DeFi's, Cross-Chain Liquidity enabler
                    network that allows its users to earn compound interest on
                    their crypto holdings. Through a set of investment
                    strategies secured and enforced by smart contracts, LinkDao
                ...
                <div className="supported-coin item-column">
                  ...
                  <div className="exchange-rate column-value">
                    <span> 1 LKD = 0.25 BUSD / 1 BUSD = 4.00 LKD</span>
                  </div>
                </div>
                ...
                <div className="supported-coin item-column">
                  ...
                  <div className="exchange-rate column-value">
                    <span className="theme_color">
                      {" "}
                      <a
                        href="https://bscscan.com/address/0xaF027427DC6d31A3e7e162A710a5Fe27e63E275F"
                        style={{
                          textDecoration: "none",
                          color: "#00E3C9",
                          lineBreak: "anywhere",
                ...
                <div className="item-column">
                  ...
                  >
                    {" "}
                    Allocation:{" "}
                    <span className="amount_color">200-10,000 BUSD</span>
                    <br />{" "}
                  </div>
                  ...
                  <div className="column-value">
                    <span style={{ lineHeight: "1.5px" }}>
                      ...
                      Seed Round - 10% unlocked at TGE. The rest 90% will be
                      unlocked monthly in the next 9 months.
                    </span>
                  </div>
                </div>
                ...
                <div className="item-column">
                  ...
                  <div className="column-value">
                    LinkDao is a Decentralized Finance (DeFi) Yield Optimizer
                    ...
                    manually yourself. LinkDao up those yields!
                    <br />
                    <br />
                    Token information
                    <br />
                  ...
                  <div className="top-div">
                    <div className="amount-container">
                      ...
                      <>
                        ...
                        {/* <div className="approve"  style={{background:"rgb(255, 255, 255, 0.1)"}} onClick={handleDeposit}> */}
                        <div
                          className="approve"
